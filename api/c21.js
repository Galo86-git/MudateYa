...
async function enviarBienvenida(opts) {
  ...
  // OJO: antes esto apuntaba a /api/independientes (copy/paste del canal
  // original). Un código de C21 no existe en independientes:asesor:{codigo},
  ...
  var asunto = importado
    ? 'CENTURY 21 te dio de alta en MudateYa · tu link y QR'
    : '✅ Ya sos aliado de MudateYa a través de CENTURY 21 · tu link y QR';
